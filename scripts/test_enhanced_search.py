...
console.print("\n[bold yellow]🔍 Query 1: \"expensive resources to shut down for cost savings\"[/bold yellow]")
...
console.print("\n\n[bold yellow]🔍 Query 2: \"continuous integration build servers\"[/bold yellow]")
...
console.print("\n\n[bold yellow]🔍 Query 3: \"critical production failover systems\"[/bold yellow]")
...
console.print("\n\n[bold yellow]🔍 Query 4: \"dormant or zero-load infrastructure\"[/bold yellow]")
...
console.print("\n\n[bold yellow]🔍 Query 5: \"board presentation infrastructure\"[/bold yellow]")
...
console.print("[bold green]✓ Enhanced semantic search testing completed![/bold green]")
